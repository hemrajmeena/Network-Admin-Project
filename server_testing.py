...
def login():
    ...
    Label(login_screen, text="Developed By:- Hemraj Meena, Aryan Gupta, Bhavin Mehta, Yog Sharma", bg='white', font=("MS Sans Serif",10),height=2).place(x=700,y=570)
    Label(login_screen, text="© Copyright 2019 CDAC ATC Netcom, jaipur.", bg='white', font=("MS Sans Serif",10,'italic'),height=2).place(x=20,y=570)
...
def login_verify(event=None):
    ...
    if username1 == "" or password1 == "":
        lbl1.destroy()
        lbl1 = Label(login_screen, text="Please complete the required field!", bg='white', fg="red", font=("MS Sans Serif",15,'bold'),height=2)
        lbl1.place(x=145,y=235)
    else:
        ...
        if username1 =='admin' and password1 == 'admin':
            ...
            lbl1.destroy()
            lbl1 = Label(login_screen, text="Invalid Username or Password ", fg="red", bg='white', font=("MS Sans Serif",15,'bold'),height=2)
            lbl1.place(x=155,y=235)
...
def login_window():
    ...
    Label(log_screen, text="Admin", bg='white', font=("MS Sans Serif", 17)).place(x= 450,y= 15)
    Label(log_screen, text="Control All Conected Nodes", bg='white', font=("MS Sans Serif", 10)).place(x= 450,y= 45)
    #Admin login Logo
    ...
    Txt = Label(log_screen,text="Screen Casting",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=75,y=90)
    Txt.bind("<Button-1>", casting)
    left_side.create_line(20, 135, 330, 135, fill='gray60')
    
    Txt = Label(log_screen,text="Connected Nodes",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=55,y=150)
    Txt.bind("<Button-1>", connected_node)
    left_side.create_line(20, 195, 330, 195, fill='gray60')
    
    Txt = Label(log_screen,text="Block User",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=100,y=210)
    Txt.bind("<Button-1>", Block_user)
    left_side.create_line(20, 255, 330, 255, fill='gray60')
    
    Txt = Label(log_screen,text="Unblock User",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=90,y=270)
    Txt.bind("<Button-1>", Unblock_user)
    left_side.create_line(20, 315, 330, 315, fill='gray60')
    
    Txt = Label(log_screen,text="IP Table Status",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=75,y=330)
    Txt.bind("<Button-1>", Ip_status)
    left_side.create_line(20, 375, 330, 375, fill='gray60')
    
    Txt = Label(log_screen,text="Blocked Nodes",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=70,y=390)
    Txt.bind("<Button-1>", blocked_nodes)
    left_side.create_line(20, 435, 330, 435, fill='gray60')
    '''
    Txt = Label(log_screen,text="Block Using\nTuxcut",bg='gray30',fg='gray60', font=("MS Sans Serif",10), cursor='hand2',activeforeground = 'gray15')
    ...
    #evillimiter x=185
    Txt = Label(log_screen,text="Block Using Command",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=30,y=450)
    Txt.bind("<Button-1>", Evillimiter_terminal)
    left_side.create_line(20, 495, 330, 495, fill='gray60')
    
    Txt = Label(log_screen,text="User Details",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    Txt.place(x=80,y=510)
    Txt.bind("<Button-1>", admin_update)
    left_side.create_line(20, 555, 330, 555, fill='gray60')
    
    Txt = Label(log_screen,text="Registered Users",bg='gray30',fg='gray60', font=("MS Sans Serif",20), cursor='hand2',activeforeground = 'gray15')
    ...
    Label(log_screen, text="© Copyright 2019 CDAC ATC Netcom, jaipur.", bg='white', font=("MS Sans Serif",10,'italic'),height=2).place(x=900,y=570)
...
def unblock_user_db():
    ...
    try:
        ...
        if l > 0:
            ...
            Label(unblock2, text=string,bg='white', width=30, fg='green',font=("MS Sans Serif",15)).place(x=300,y=280)
        else:
            Label(unblock2, text="IP Already Unblocked!!", width=30,bg='white', fg='green',font=("MS Sans Serif",15)).place(x=310,y=280)
...
def register_user(event=None):
    ...
    if username_info == "" or password_info == "":
        lbl1.destroy
        lbl1 = Label(lb, text="Please complete the required field!", bg='white', fg="red", font=("MS Sans Serif", 15))
        lbl1.place(x=440,y=300)
    elif len(password_info) < 6:
        lbl1.destroy
        lbl1 = Label(lb, text="Size of password is more than 6 !!", bg='white', fg="red", font=("MS Sans Serif", 15))
        lbl1.place(x=440,y=300)
    else:
        try:
            #post request
            ...
            if rqst.status_code == 200:
                lbl1.destroy()
                lbl1 = Label(lb, text="User added successfuly!!", bg='white', fg="green", font=("MS Sans Serif", 15))
                lbl1.place(x=490,y=300)
            elif rqst.status_code == 500:
                lbl1.destroy()
                lbl1 = Label(lb, text="User Already Exist!!", bg='white', fg="red", font=("MS Sans Serif", 15))
                lbl1.place(x=490,y=300)
            else:
                lbl1.destroy()
                lbl1 = Label(lb, text="User not added", bg='white', fg="red", font=("MS Sans Serif", 15))
                lbl1.place(x=490,y=300)
        except:
            lbl1.destroy()
            lbl1 = Label(lb, text="Server is off.. Try again later!!", fg="red", bg='white', font=("MS Sans Serif", 15))
    ...
    if  usertest == "" or passtest1 == "" or passtest2 == "":
        ...
        try:
            if passtest1 == passtest2:            
                ...
                if rqst.status_code == 200:
                    lbl1.destroy()
                    lbl1 = Label(lb, text="Password changed!!", bg='white', fg="green", font=("MS Sans Serif", 15))
                    lbl1.place(x=200,y=340)
                else:
                    lbl1.destroy()
                    lbl1 = Label(lb, text="Please enter your valid username!", bg='white', fg="red", font=("MS Sans Serif", 15))
                    lbl1.place(x=150,y=340)
            else:
                lbl1.destroy()
                lbl1 = Label(lb, text="Password not matched!", bg='white', fg="red", font=("MS Sans Serif", 15))
                lbl1.place(x=200,y=340)
        except:
            lbl1.destroy()
            lbl1 = Label(lb, text="Server is off.. Try again later!!", fg="red", bg='white', font=("MS Sans Serif", 15))
...
def Regitered_users(event=None):
    ...
    for i in range(len(non_active)):
        Label(label1, text=non_active[i],bg='white',font=("MS Sans Serif",17)).place(x=30, y=60+x)
        x +=37
    x=0
    for i in range(len(res)):    
        Label(label2, text=res[i],bg='white',font=("MS Sans Serif",17)).place(x=30, y=60+x)
        x +=37
