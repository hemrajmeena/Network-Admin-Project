...
def register():
    ...
    register_screen = Frame(bg="white",width="1200",height="600")
    ...
    Label(register_screen, text="Register", bg="white", width="30", font=("MS Sans Serif",25,"bold")).place(x=55,y=190)
    Label(register_screen, text="Username : ",font=("MS Sans Serif",15),bg='white').place(x=90,y=290)
    username_entry = Entry(register_screen, textvariable=username,width="30", bd=3,font=("Times",15))
    username_entry.place(x=200,y=290)
    Label(register_screen, text="Password : ", font=("MS Sans Serif",15),bg='white').place(x=90,y=350)
    ...
    Button(register_screen, text="Register", command = register_user, font=("MS Sans Serif",13),width='12', height='1', borderwidth=2, relief= RAISED, activebackground = 'slate blue', activeforeground = 'white',fg='white',bg='royalblue1',cursor='hand2').place(x=185,y=450)
    Button(register_screen, text="Sign in", command=go_back_to_login, font=("MS Sans Serif",13),width='12', height='1', borderwidth=2, relief= RAISED, activebackground = 'slate blue', activeforeground = 'white',fg='white',bg='royalblue1',cursor='hand2').place(x=365,y=450)
...
def login():
    ...
    login_screen = Frame(bg="white",width="1200",height="700")
    ...
    bg_img = ImageTk.PhotoImage(Image.open(Path))
    label = Label(login_screen, image = bg_img, bg='white', width='680',height='550')
    label.image = bg_img
    label.configure(image = bg_img)
    ...
    Button(login_screen, text="Login",font=("MS Sans Serif",13),width='15', height='1',fg='white', borderwidth=2, relief= RAISED, command = login_verify, activebackground = 'Darkorchid1', activeforeground = 'white', bg='purple',cursor='hand2').place(x=155,y=430)
    Button(login_screen, text="Register",font=("MS Sans Serif",13),width='15', height='1', fg='white', borderwidth=2, relief= RAISED, command = register, activebackground = 'Darkorchid1', activeforeground = 'white', bg='purple',cursor='hand2').place(x=340,y=430)
    Label(login_screen, text="Developed By:- Hemraj Meena, Aryan Gupta, Bhavin Mehta, Yog Sharma", bg='white',fg='purple', font=("MS Sans Serif",10),height=2).place(x=700,y=570)
    Label(login_screen, text="© Copyright 2019 CDAC ATC Netcom, jaipur.", bg='white',fg='purple', font=("MS Sans Serif",10,'italic'),height=2).place(x=20,y=570)    
...
def forget_pass(event):
    ...
    login_screen.destroy()
    #forget screen 
    forget_screen = Frame(bg="white",width="1200",height="600")
    ...
    Label(forget_screen, text="Forget Password", width="25", font=("MS Sans Serif",25,'bold'),bg='white').place(x=110,y=190) 
    labelu = Label(forget_screen, text="Username : ",font=("MS Sans Serif",15),bg='white')
    ...
    Label(forget_screen, text="Password : ", font=("MS Sans Serif",15),bg='white').place(x=90,y=350)
    ...
    Label(forget_screen, text="Confirm Password : ", font=("MS Sans Serif",15),bg='white').place(x=15,y=410)
...
def login_window():
    ...
    lbl1.destroy()
    log_screen = Frame(bg="white",width="1200",height="600")
    ...
    def Draw():
        global text
        text= Label(log_screen,text='Date',font=('MS Sans Serif', 17), bg='white')
    ...
    global time1
    time1 = ''
    clock = Label(log_screen, font=('MS Sans Serif', 17), bg='white')
    ...
    Label(log_screen, text=f"Welcome {user}", font=("MS Sans Serif",25),bg='white').place(x=90,y=195) 
    Label(log_screen, text= "Now You can Access Internet..!!",font=("MS Sans Serif",20,'bold'),bg='white').place(x=90,y=320)
    
    # button for seeing bandwidth consumption
    btn = Button(log_screen, text="Speed",font=("MS Sans Serif",13,'bold'), bg='white',borderwidth=1, relief= RAISED, command = bandwidth_consumption, cursor='hand2')
    btn.place(x=350,y=380)

    #logout button    
    Button(log_screen, text="Logout",font=("MS Sans Serif",13),width='20', height='1',bg='white', borderwidth=1, relief= RAISED, command = logout, cursor='hand2').place(x=100,y=440)
...
def port_assign():
    ...
    def casting_popup():
        ...
        def fun():
            ...
            l = Label(win, text="Server request for casting.\nPlease press cast button..!!",font=("MS Sans Serif",20),bg='white')
...
def bandwidth_consumption():
    ...
    bnd_width=0.000
    lb = Label(log_screen,font=("MS Sans Serif",30,'italic'),bg='white')
